...
export const CM_SETTINGS_DEFAULTS = {
  [CM_SETTINGS_KEYS.HIGHLIGHT_THRESHOLD]: 1, // 默认 1MB
  [CM_SETTINGS_KEYS.LINEWRAP_THRESHOLD]: 1, // 默认 1MB
  [CM_SETTINGS_KEYS.FOLD_INDENT_THRESHOLD]: 1, // 默认 1MB
  [CM_SETTINGS_KEYS.ENABLE_HYPERLINK]: true,
